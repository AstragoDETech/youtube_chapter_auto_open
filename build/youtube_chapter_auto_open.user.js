...
// @version     1.0
// @author      AstragoDE
// @description 5/26/2022, 8:32:39 PM
// @run-at      document-end
// ==/UserScript==
...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      var t1 = {};
      t1.currentLoc = type$.Location._as(window.location).href;
      t1.lastLoc = "";
      A.Timer_Timer$periodic(A.Duration$(250), new A.main_closure(t1));
    },
  ...
  A.main_closure.prototype = {
    call$1(timer) {
      var currentLoc = type$.Location._as(window.location).href,
        t1 = this._box_0;
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Closure, [A.Closure0Args, A.Closure2Args, A.TearOffClosure, A.initHooks_closure, A.initHooks_closure1, A._AsyncRun__initializeScheduleImmediate_internalCallback, A._AsyncRun__initializeScheduleImmediate_closure, A._RootZone_bindUnaryCallbackGuarded_closure, A.main_closure, A.main__closure]);
    _inheritMany(A.TearOffClosure, [A.StaticClosure, A.BoundClosure]);
    _inherit(A.initHooks_closure0, A.Closure2Args);
    _inherit(A._TypeError, A._Error);
    _inheritMany(A.Closure0Args, [A._AsyncRun__scheduleImmediateJsOverride_internalCallback, A._AsyncRun__scheduleImmediateWithSetImmediate_internalCallback, A._TimerImpl_internalCallback, A._TimerImpl$periodic_closure, A._rootHandleError_closure]);
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["Null()", "~()", "~(~())", "~(Timer)", "@(@)", "@(@,String)", "@(String)", "Null(@)", "Null(~())"],
...
//# sourceMappingURL=youtube_chapter_auto_open.user.js.map
